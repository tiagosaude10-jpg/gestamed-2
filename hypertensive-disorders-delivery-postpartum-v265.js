...
function start(){api=window.GestaMedHDPState;if(!api){window.setTimeout(start,100);return;}ensureStyle();observe();document.documentElement.setAttribute('data-gm-hdp-delivery-postpartum',PATCH_ID);}
