...
function init(){addStyle();var r=root();if(!r){setTimeout(init,150);return;}var obs=new MutationObserver(function(){setTimeout(insert,0);});obs.observe(r,{subtree:true,childList:true,attributes:true,attributeFilter:['hidden','data-topic']});r.addEventListener('click',function(e){if(e.target.closest&&e.target.closest('[data-master-topic="hospital"]'))setTimeout(insert,0);});insert();}
