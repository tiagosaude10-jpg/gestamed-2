const CACHE='tomocron-v21-direct-home-2026-08-20';
const CORE=['./','./index.html','./app.css?v=21','./app.js?v=21','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./logo-tomocron-final.jpg?v=21'];
