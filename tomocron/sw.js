const CACHE='tomocron-v30-command-screen-2026-08-20';
const CORE=['./','./index.html','./app.css?v=27','./app.js?v=27','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./logo-tomocron-final.jpg?v=24'];
