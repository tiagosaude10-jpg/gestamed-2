...
function ensureStyle(){
  ...
  var s=document.createElement('style');s.id=STYLE_ID;s.textContent=[
    '.gm-hdp-state-summary{display:block!important;box-sizing:border-box;width:100%;padding:14px;border:1px solid rgba(190,45,91,.12);border-radius:20px;background:linear-gradient(135deg,#fff,#f3fbf5);box-shadow:0 8px 22px rgba(61,88,67,.07);}',
    '.gm-hdp-state-summary.is-compact{padding:0;border:0;background:transparent;box-shadow:none;}',
    '.gm-hdp-state-summary .gm-hdp-state-summary-head{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;width:100%;}.gm-hdp-state-summary .gm-hdp-state-summary-head>div{min-width:0;flex:1 1 auto;}.gm-hdp-state-summary .gm-hdp-state-summary-head span{display:block;color:#9a4965;font-size:10px;font-weight:850;text-transform:uppercase;letter-spacing:.7px;}.gm-hdp-state-summary .gm-hdp-state-summary-head strong{display:block;margin-top:3px;color:#6f1738;font-size:15px;overflow-wrap:anywhere;}.gm-hdp-state-summary .gm-hdp-state-summary-head button{flex:0 0 auto;border:1px solid rgba(183,35,80,.15);border-radius:12px;background:#fff;color:#b62455;padding:7px 10px;font-size:11px;font-weight:800;cursor:pointer;}',
    '.gm-hdp-state-summary .gm-hdp-state-chips{display:flex;flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:6px;margin-top:9px;width:100%;}.gm-hdp-state-summary .gm-hdp-state-chips span{flex:0 0 auto;padding:6px 9px;border-radius:999px;background:#f7edf1;color:#6d2941;font-size:11px;font-weight:750;white-space:nowrap;}.gm-hdp-state-summary>small{display:block;margin-top:8px;color:#758094;font-size:10px}.gm-hdp-state-slot{margin-bottom:12px}',
