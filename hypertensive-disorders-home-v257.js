...
function ensureStyle(){
  ...
  s.textContent=[
    ...
    '#gm-app-flow .gm-hdp-patient-card span{color:#47715c;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.7px;}',
    '#gm-app-flow .gm-hdp-patient-card strong{color:#375746;font-size:12px;text-align:right;}',
