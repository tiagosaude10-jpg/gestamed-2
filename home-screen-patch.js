(function () {
  ...
  var PATCH_ID = 'gestamed-entry-flow-2026-08-14-198';
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      '.gm-screen-shell{box-sizing:border-box;position:relative;width:min(100%,520px);min-height:100%;margin:0 auto;background:#fff1f4 url("gestamed-background-clean.jpg?v=198") center/cover no-repeat;overflow:hidden;box-shadow:0 0 40px rgba(98,37,65,.12);}',
      ...
      '.gm-home-shell{box-sizing:border-box;position:relative;width:min(100%,600px);min-height:100%;margin:0 auto;padding:0 14px max(18px,env(safe-area-inset-bottom));background:#fff4f7 url("gestamed-background-clean.jpg?v=198") center top/cover no-repeat;box-shadow:0 0 40px rgba(98,37,65,.12);color:#17233c;}',
  ...
  function buildWelcome() {
    ...
    screen.innerHTML = '<div class="gm-screen-shell gm-welcome-shell">' +
      '<div class="gm-brand"><img class="gm-brand-symbol" src="gestamed-logo-cutout-v190.png?v=198" alt="Símbolo GestaMed"><h1 class="gm-brand-name"><b>Gesta</b>Med</h1><p class="gm-brand-subtitle">Apoio clínico para<br>profissionais e estudantes.</p><div class="gm-heart-divider" aria-hidden="true">♥</div></div>' +
      '<img class="gm-hero-art" src="gestamed-hero.jpg?v=198" alt="Ilustração de uma gestante em tons de rosa">' +
  ...
  function buildHome() {
    ...
    shell.innerHTML = '<header class="gm-command-header"><div class="gm-command-brand-area"><div class="gm-command-brand-row"><img class="gm-command-logo" src="gestamed-logo-cutout-v190.png?v=198" alt="Símbolo GestaMed"><h1 class="gm-command-name"><b>Gesta</b>Med</h1></div><p class="gm-command-tagline">Cuidar com conhecimento,<br>decidir com segurança.</p><div class="gm-command-heart" aria-hidden="true">♥</div><div class="gm-command-actions"><button class="gm-command-action gm-command-notices" type="button" aria-label="Abrir avisos">🔔' + noticeBadge + '</button><button class="gm-command-action gm-command-logout" type="button" aria-label="Sair da conta">↪</button></div></div><div class="gm-command-clinician" aria-hidden="true"><img src="gestamed-clinician-cutout-v190.png?v=198" alt=""></div><div class="gm-command-greeting"><h2>Olá, <span data-gm-display-name>Profissional</span>! <span aria-hidden="true">♥</span></h2><p>Acesse conteúdos confiáveis para apoiar sua prática com excelência.</p></div></header>' +
