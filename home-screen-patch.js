(function () {
  ...
  var PATCH_ID = 'gestamed-entry-flow-2026-08-14-189';
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      '.gm-screen-shell{position:relative;width:min(100%,520px);min-height:100%;margin:0 auto;background:#fff1f4 url("gestamed-background-clean.jpg?v=189") center/cover no-repeat;overflow:hidden;box-shadow:0 0 40px rgba(98,37,65,.12);}',
      ...
      '.gm-home-shell{box-sizing:border-box;position:relative;width:min(100%,600px);min-height:100%;margin:0 auto;padding:0 14px max(18px,env(safe-area-inset-bottom));background:#fff4f7 url("gestamed-background-clean.jpg?v=189") center top/cover no-repeat;box-shadow:0 0 40px rgba(98,37,65,.12);color:#17233c;}',
      '.gm-command-header{box-sizing:border-box;position:relative;min-height:224px;padding:14px 0 8px;overflow:hidden;}.gm-command-brand-area{position:relative;z-index:2;width:59%;text-align:center;}.gm-command-brand-row{display:flex;align-items:center;justify-content:center;gap:5px;}.gm-command-logo{width:52px;height:62px;object-fit:cover;mix-blend-mode:multiply;}.gm-command-name{margin:0;color:#ef6d90;font-size:clamp(29px,8vw,46px);font-weight:300;letter-spacing:-1.8px;line-height:1;white-space:nowrap;}.gm-command-name b{color:#d40b50;font-weight:720;}.gm-command-tagline{margin:3px 0 0;color:#92506a;font-size:clamp(8px,2.15vw,12px);font-weight:750;line-height:1.38;letter-spacing:.35px;text-transform:uppercase;}.gm-command-heart{display:flex;align-items:center;justify-content:center;gap:7px;margin-top:4px;color:#ef4c82;font-size:12px;}.gm-command-heart:before,.gm-command-heart:after{content:"";width:30px;height:1px;background:#ecabc0;}.gm-command-clinician{position:absolute;z-index:1;top:0;right:-14px;width:45%;height:190px;overflow:hidden;border-radius:0 0 0 26px;pointer-events:none;}.gm-command-clinician img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center 19%;user-select:none;-webkit-user-drag:none;}.gm-command-greeting{position:relative;z-index:2;width:59%;margin-top:17px;padding-left:1px;}.gm-command-greeting h2{margin:0;color:#121b31;font-size:clamp(19px,5.2vw,27px);line-height:1.08;white-space:nowrap;}.gm-command-greeting h2 span{color:#f04c80;}.gm-command-greeting p{margin:6px 0 0;color:#26324a;font-size:clamp(11px,3.25vw,15px);line-height:1.4;}',
  ...
  function buildWelcome() {
    ...
    screen.innerHTML = '<div class="gm-screen-shell gm-welcome-shell">' +
      '<div class="gm-brand"><img class="gm-brand-symbol" src="gestamed-logo-symbol.jpg?v=189" alt="Símbolo GestaMed"><h1 class="gm-brand-name"><b>Gesta</b>Med</h1><p class="gm-brand-subtitle">Apoio clínico para<br>profissionais e estudantes.</p><div class="gm-heart-divider" aria-hidden="true">♥</div></div>' +
      '<img class="gm-hero-art" src="gestamed-hero.jpg?v=189" alt="Ilustração de uma gestante em tons de rosa">' +
  ...
  function buildHome() {
    ...
    shell.innerHTML = '<header class="gm-command-header"><div class="gm-command-brand-area"><div class="gm-command-brand-row"><img class="gm-command-logo" src="gestamed-logo-symbol.jpg?v=189" alt="Símbolo GestaMed"><h1 class="gm-command-name"><b>Gesta</b>Med</h1></div><p class="gm-command-tagline">Cuidar com conhecimento,<br>decidir com segurança.</p><div class="gm-command-heart" aria-hidden="true">♥</div></div><div class="gm-command-clinician" aria-hidden="true"><img src="gestamed-clinician-header-v188.jpg?v=189" alt=""></div><div class="gm-command-greeting"><h2>Olá, Profissional! <span>♥</span></h2><p>Acesse conteúdos confiáveis para<br>apoiar sua prática com excelência.</p></div></header>' +
