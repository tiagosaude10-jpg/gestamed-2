(function () {
  ...
  var PATCH_ID = 'gestamed-entry-flow-2026-08-14-188';
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      '.gm-screen-shell{position:relative;width:min(100%,520px);min-height:100%;margin:0 auto;background:#fff1f4 url("gestamed-background-clean.jpg?v=188") center/cover no-repeat;overflow:hidden;box-shadow:0 0 40px rgba(98,37,65,.12);}',
  ...
  function buildWelcome() {
    ...
    screen.innerHTML = '<div class="gm-screen-shell gm-welcome-shell">' +
      '<div class="gm-brand"><img class="gm-brand-symbol" src="gestamed-logo-symbol.jpg?v=188" alt="Símbolo GestaMed"><h1 class="gm-brand-name"><b>Gesta</b>Med</h1><p class="gm-brand-subtitle">Apoio clínico para<br>profissionais e estudantes.</p><div class="gm-heart-divider" aria-hidden="true">♥</div></div>' +
      '<img class="gm-hero-art" src="gestamed-hero.jpg?v=188" alt="Ilustração de uma gestante em tons de rosa">' +
  ...
  function buildHome() {
    ...
    shell.innerHTML = '<header class="gm-command-header"><div class="gm-command-brand-area"><div class="gm-command-brand-row"><img class="gm-command-logo" src="gestamed-logo-symbol.jpg?v=188" alt="Símbolo GestaMed"><h1 class="gm-command-name"><b>Gesta</b>Med</h1></div><p class="gm-command-tagline">Cuidar com conhecimento,<br>decidir com segurança.</p><div class="gm-command-heart" aria-hidden="true">♥</div></div><div class="gm-command-clinician" aria-hidden="true"><img src="gestamed-clinician-header-v188.jpg?v=188" alt=""></div><div class="gm-command-greeting"><h2>Olá, Profissional! <span>♥</span></h2><p>Acesse conteúdos confiáveis para<br>apoiar sua prática com excelência.</p></div></header>' +
