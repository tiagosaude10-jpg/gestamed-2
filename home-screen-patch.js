(function () {
  ...
  var PATCH_ID = 'gestamed-entry-flow-2026-08-14-186';
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      '.gm-screen-shell{position:relative;width:min(100%,520px);min-height:100%;margin:0 auto;background:#fff1f4 url("gestamed-background-clean.jpg?v=186") center/cover no-repeat;overflow:hidden;box-shadow:0 0 40px rgba(98,37,65,.12);}',
      ...
      '.gm-home-shell{box-sizing:border-box;position:relative;width:min(100%,600px);min-height:100%;margin:0 auto;padding:0 16px max(14px,env(safe-area-inset-bottom));background:#fff4f7 url("gestamed-background-clean.jpg?v=186") center top/cover no-repeat;box-shadow:0 0 40px rgba(98,37,65,.12);color:#17233c;}',
      '.gm-command-header{box-sizing:border-box;position:relative;min-height:300px;padding:24px 0 8px;overflow:hidden;}.gm-command-brand-area{position:relative;z-index:2;width:63%;text-align:center;}.gm-command-brand-row{display:flex;align-items:center;justify-content:center;gap:8px;}.gm-command-logo{width:74px;height:88px;object-fit:cover;mix-blend-mode:multiply;}.gm-command-name{margin:0;color:#ef6d90;font-size:clamp(34px,9.4vw,52px);font-weight:300;letter-spacing:-2.4px;line-height:1;white-space:nowrap;}.gm-command-name b{color:#d40b50;font-weight:720;}.gm-command-tagline{margin:4px 0 0;color:#92506a;font-size:clamp(9px,2.55vw,13px);font-weight:750;line-height:1.45;letter-spacing:.5px;text-transform:uppercase;}.gm-command-heart{display:flex;align-items:center;justify-content:center;gap:8px;margin-top:6px;color:#ef4c82;font-size:14px;}.gm-command-heart:before,.gm-command-heart:after{content:"";width:38px;height:1px;background:#ecabc0;}.gm-command-clinician{position:absolute;z-index:1;top:0;right:-16px;width:47%;height:clamp(180px,47vw,282px);overflow:hidden;pointer-events:none;}.gm-command-clinician img{position:absolute;top:-7.5vw;left:-117.4%;width:217.4%;height:auto;max-width:none;user-select:none;-webkit-user-drag:none;}.gm-command-greeting{position:relative;z-index:2;width:63%;margin-top:38px;}.gm-command-greeting h2{margin:0;color:#121b31;font-size:clamp(22px,6vw,30px);line-height:1.1;}.gm-command-greeting h2 span{color:#f04c80;}.gm-command-greeting p{margin:8px 0 0;color:#26324a;font-size:clamp(13px,3.8vw,17px);line-height:1.45;}',
      '.gm-command-search{position:relative;z-index:4;display:grid;grid-template-columns:46px 1fr 48px;align-items:center;height:62px;margin:0 0 14px;border:1px solid rgba(234,93,137,.18);border-radius:24px;background:rgba(255,255,255,.92);box-shadow:0 8px 24px rgba(191,42,91,.1);overflow:hidden;}.gm-command-search button{height:100%;border:0;background:transparent;color:#ef1760;cursor:pointer;font-size:25px;}.gm-command-search input{box-sizing:border-box;width:100%;height:100%;border:0;outline:0;background:transparent;color:#26324a;font-size:15px;}.gm-command-search input::placeholder{color:#a59ea3;}.gm-command-filter-button{border-left:1px solid rgba(234,93,137,.1)!important;font-size:23px!important;}',
      '.gm-command-filter-row{display:flex;gap:9px;margin:0 -2px 18px;padding:2px 2px 5px;overflow-x:auto;scrollbar-width:none;}.gm-command-filter-row::-webkit-scrollbar{display:none;}.gm-command-filter-chip{flex:0 0 auto;min-width:92px;height:46px;padding:0 14px;border:1px solid rgba(116,151,174,.24);border-radius:23px;background:rgba(255,255,255,.88);box-shadow:0 5px 14px rgba(92,49,70,.07);color:#1b2336;font-size:14px;font-weight:720;cursor:pointer;white-space:nowrap;}',
      '.gm-command-section-title{margin:12px 2px 10px;color:#182139;font-size:20px;line-height:1.1;}.gm-command-quick-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px;margin-bottom:16px;}.gm-command-quick{min-width:0;min-height:104px;padding:10px 3px 8px;border:1px solid rgba(236,133,166,.15);border-radius:18px;background:rgba(255,255,255,.72);box-shadow:0 6px 16px rgba(96,39,65,.06);color:#172138;cursor:pointer;}.gm-command-quick-icon{display:grid;place-items:center;height:54px;color:#f23878;font-size:34px;line-height:1;}.gm-command-quick-label{display:block;font-size:11px;font-weight:720;white-space:nowrap;}',
      '.gm-command-module-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:11px;margin-bottom:12px;}.gm-command-module{box-sizing:border-box;display:grid;grid-template-columns:54px 1fr 30px;align-items:center;gap:9px;min-height:105px;padding:12px;border:1px solid var(--gm-card-border,rgba(68,122,184,.13));border-radius:19px;background:var(--gm-card-bg,#fff);box-shadow:0 5px 14px rgba(88,41,65,.04);color:#172138;text-align:left;cursor:pointer;}.gm-command-module-icon{display:grid;place-items:center;width:52px;height:52px;border-radius:50%;background:var(--gm-icon-bg,#e4f2ff);font-size:29px;}.gm-command-module-copy strong{display:block;font-size:14px;line-height:1.22;}.gm-command-module-copy small{display:block;margin-top:4px;color:#40506c;font-size:11px;line-height:1.25;}.gm-command-arrow{display:grid;place-items:center;width:28px;height:28px;border-radius:50%;background:var(--gm-accent,#1689ed);color:#fff;font-size:24px;line-height:1;}.gm-card-blue{--gm-card-bg:rgba(231,243,255,.9);--gm-accent:#1689ed;--gm-icon-bg:#d9efff;}.gm-card-pink{--gm-card-bg:rgba(255,231,238,.88);--gm-accent:#f43776;--gm-icon-bg:#ffd4df;}.gm-card-green{--gm-card-bg:rgba(237,248,238,.9);--gm-accent:#31b43c;--gm-icon-bg:#dbf3df;}.gm-card-purple{--gm-card-bg:rgba(243,235,255,.9);--gm-accent:#a54ef2;--gm-icon-bg:#ebdcff;}.gm-card-orange{--gm-card-bg:rgba(255,246,229,.9);--gm-accent:#ffa000;--gm-icon-bg:#ffedc7;}',
      ...
      '.gm-command-nav{position:sticky;z-index:20;bottom:max(0px,env(safe-area-inset-bottom));display:grid;grid-template-columns:repeat(5,minmax(0,1fr));align-items:end;margin:0 -5px;padding:7px 3px 5px;border:1px solid rgba(236,133,166,.16);border-radius:22px;background:rgba(255,255,255,.94);box-shadow:0 -7px 22px rgba(102,42,67,.08);backdrop-filter:blur(14px);}.gm-command-nav button{min-width:0;padding:2px;border:0;background:transparent;color:#40475a;cursor:pointer;font-size:10px;}.gm-command-nav-icon{display:block;margin-bottom:3px;color:#c05b81;font-size:24px;line-height:1;}.gm-command-nav .gm-nav-active{color:#ef1760;font-weight:760;}.gm-command-nav .gm-nav-active .gm-command-nav-icon{color:#ef1760;}.gm-command-nav .gm-nav-main{transform:translateY(-10px);}.gm-command-nav .gm-nav-main .gm-command-nav-icon{display:grid;place-items:center;width:52px;height:52px;margin:-12px auto 2px;border-radius:50%;background:linear-gradient(145deg,#f8568b,#ed1f63);box-shadow:0 8px 18px rgba(229,35,99,.28);color:#fff;font-size:30px;}',
      ...
      '@media(min-width:700px){.gm-screen-shell,.gm-home-shell{min-height:calc(100% - 48px);margin:24px auto;border-radius:36px;}.gm-command-clinician img{top:-45px;}}',
      '@media(max-width:430px){.gm-command-header{min-height:275px;}.gm-command-logo{width:60px;height:72px;}.gm-command-greeting{margin-top:34px;}.gm-command-quick-grid{gap:5px;}.gm-command-quick{min-height:94px;}.gm-command-quick-icon{height:48px;font-size:29px;}.gm-command-quick-label{font-size:9px;}.gm-command-module{grid-template-columns:45px 1fr 25px;gap:7px;min-height:100px;padding:9px;}.gm-command-module-icon{width:44px;height:44px;font-size:25px;}.gm-command-arrow{width:25px;height:25px;font-size:20px;}.gm-command-module-copy strong{font-size:12px;}.gm-command-module-copy small{font-size:9px;}.gm-command-stat{grid-template-columns:31px 1fr;padding:3px 5px;}.gm-command-stat-icon{width:30px;height:30px;font-size:17px;}.gm-command-stat strong{font-size:14px;}.gm-command-stat small{font-size:8px;}}',
      '@media(max-width:350px){.gm-command-module-grid{grid-template-columns:1fr;}.gm-command-brand-area,.gm-command-greeting{width:66%;}.gm-command-clinician{width:43%;}.gm-command-stat-grid{grid-template-columns:1fr;}.gm-command-stat+.gm-command-stat{border-left:0;border-top:1px solid rgba(232,105,145,.18);}}',
  ...
  function buildWelcome() {
    ...
    screen.innerHTML = '<div class="gm-screen-shell gm-welcome-shell">' +
      '<div class="gm-brand"><img class="gm-brand-symbol" src="gestamed-logo-symbol.jpg?v=186" alt="Símbolo GestaMed"><h1 class="gm-brand-name"><b>Gesta</b>Med</h1><p class="gm-brand-subtitle">Apoio clínico para<br>profissionais e estudantes.</p><div class="gm-heart-divider" aria-hidden="true">♥</div></div>' +
      '<img class="gm-hero-art" src="gestamed-hero.jpg?v=186" alt="Ilustração de uma gestante em tons de rosa">' +
  ...
  function buildHome() {
    ...
    shell.innerHTML = '<header class="gm-command-header"><div class="gm-command-brand-area"><div class="gm-command-brand-row"><img class="gm-command-logo" src="gestamed-logo-symbol.jpg?v=186" alt="Símbolo GestaMed"><h1 class="gm-command-name"><b>Gesta</b>Med</h1></div><p class="gm-command-tagline">Cuidar com conhecimento,<br>decidir com segurança.</p><div class="gm-command-heart" aria-hidden="true">♥</div></div><div class="gm-command-clinician" aria-hidden="true"><img src="F4907271-BC9F-4AC0-AED2-75E16DFBB496.png?v=186" alt=""></div><div class="gm-command-greeting"><h2>Olá, Profissional! <span>♥</span></h2><p>Acesse conteúdos confiáveis para<br>apoiar sua prática com excelência.</p></div></header>' +
    ...
    shell.querySelector('[data-gm-nav="obstetricia"]').addEventListener('click', function () { if (!activate(['Obstetrícia','Obstetricia'])) showDevelopmentMessage('Obstetrícia'); });
